...
oso1 = Material(diffuse = WHITE, albedo = (0.8, 0.8, 0.1), spec = 30)
adorno1 = Material(diffuse = GRAY, albedo = (1, 1, 0.1), spec = 30)
mona1 = Material(diffuse = RED, albedo = (0.6, 0.3, 0.1), spec = 15)
oso2 = Material(diffuse = BROWN, albedo = (0.9, 0.8, 0.1), spec = 30)
tono2 = Material(diffuse = ORANGE, albedo = (0.6, 0.3, 0.1), spec = 15)
tono3 = Material(diffuse = ORANGE2, albedo = (0.6, 0.3, 0.1), spec = 15)
adorno2 = Material(diffuse = MAROON, albedo = (0.9, 0.9, 0.1), spec = 30)
